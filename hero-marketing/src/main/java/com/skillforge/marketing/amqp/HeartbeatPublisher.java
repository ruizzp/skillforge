...
public class HeartbeatPublisher {
    ...
    public HeartbeatPublisher(
            ...
            @Value("${skillforge.hero.id:hero-marketing}") String heroId,
            @Value("${skillforge.hero.name:Hero Marketing}") String heroName,
            @Value("${skillforge.hero.skills:pitch-scribe,narrative-design,audience-segmentation,structured-writing}") String skillsCsv) {
        this.rabbit   = rabbit;
