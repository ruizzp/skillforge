package com.skillforge.marketing.client;
...
public class AnthropicClient {
    ...
    public String generate(String systemPromptFile, String userMessage, double temperature) throws Exception {
        if (apiKey.isBlank()) throw new IllegalStateException("ANTHROPIC_API_KEY não configurado");

        String systemPrompt = loadPrompt(systemPromptFile);
    ...
    private String loadPrompt(String filename) throws Exception {
